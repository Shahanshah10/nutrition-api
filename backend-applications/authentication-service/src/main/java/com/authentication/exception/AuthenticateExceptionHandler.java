...
public class AuthenticateExceptionHandler {
    ...
    //Custom exception handler for Incorrect Username or Password
    @ExceptionHandler(value = UserBadRequestException.class)
    public ResponseEntity<ErrorResponse> handleSupplierAlreadyExistsException(UserBadRequestException ex) {
